...
The data dictionary for the `sleep_source` data set may be downloaded from [`inst/extdata`](https://github.com/deboonstra/pregnancy247/blob/main/inst/extdata/Pregnancy247SleepDatabase_DataDictionary_2023-08-16.csv) of the package [Github](https://github.com/deboonstra/pregnancy247/tree/main)
...
The data dictionaries for these outputted data sets may be downloaded from [`inst/extdata`](https://github.com/deboonstra/pregnancy247/tree/main/inst/extdata) of the package [Github](https://github.com/deboonstra/pregnancy247/tree/main). The file names of the dictionaries are related to the outputted data sets.