...
The data dictionary for the `sleep_source` data set may be downloaded from [`inst/extdata`](https://github.com/deboonstra/pregnancy247/tree/main/inst/extdata) of the package [Github](https://github.com/deboonstra/pregnancy247/tree/main)
